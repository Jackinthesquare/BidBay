    ...
    return (
        <div className="footer-container">
            <div className='icon-container'>
                ...
                <a href="https://www.linkedin.com"><img className='footer-icon' src="https://cdn2.iconfinder.com/data/icons/social-media-2285/512/1_Linkedin_unofficial_colored_svg-128.png" /></a>
                ...
                <a href="https://github.com"><img className='footer-icon' id='github-icon' src="https://cdn4.iconfinder.com/data/icons/social-media-logos-6/512/71-github-128.png" /></a>
            </div>
